...
Na tela do ticket, gestores podem alterar a prioridade dos tickets da própria equipe. A alteração é registrada no histórico do ticket.
...
| --------------- | :-----------: | :----------------------------------------: | :--------: |
| 🏃🏻 **Sprint 1** | 07/09 – 27/09 | [Docs](./docs/sprints/sprint-backlog-1.md) |            |
| 🏃🏻 **Sprint 2** | 05/10 – 25/10 | [Docs](./docs/sprints/sprint-backlog-2.md) |            |
| 🏃🏻 **Sprint 3** | 02/11 – 22/11 | [Docs](./docs/sprints/sprint-backlog-3.md) |            |
